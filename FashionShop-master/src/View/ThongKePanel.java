...
//    private DateChooser chDate = new DateChooser();
    ...
    ChiTietQuanAoService cTQAS;
    
    public ThongKePanel() {
        initComponents();
        cTQAS = new ChiTietQuanAoService();
        ...
        tblHoaDon("select COUNT(hd.MaHD) as TongHoaDon , SUM(cthd.SoLuong * cthd.DonGia) as TongDoanhThu,NgayTao as NT from HoaDon hd\n"
                ...
                + "on hd.Id = cthd.IdHD\n"
                + "group by NgayTao");
        lblHN.setText(cTHDR.loadTongHoaDon() + " " + "đơn hàng");
        lblTongDT.setText(cTHDR.loadTongDoanhThu() + " " + "VND");
    }
    ...
    public void loadTatCaSanPham() {
        DefaultTableModel dtm = (DefaultTableModel) this.tblSPCT.getModel();
        dtm.setRowCount(0);
        for (ChiTietQuanAoRespone kh : this.cTQAS.getAllCTQA()) {
            Object[] rowData = {
                kh.getId(),
                kh.getMaSP(),
                kh.getTenSP(),
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThongKePanel().setVisible(true);
            }
        });
    }
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblHN, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        lblTongDT.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        lblTongDT.setText("         0");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(21, 21, 21))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addComponent(lblTongDT, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(30, 30, 30))))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblTongDT, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tblSPCT.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã Quần Áo", "Tên quần áo", "Màu", "Kích Cỡ", "Thể Loại", "Số lượng ", "Tình Trạng"
            }
        ));
        ...
        jLabel7.setText("BẢNG THỐNG KÊ CHI TIẾT CỬA HÀNG COOLMATE SHOP");

        cboDTThang.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12" }));
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(cboDTThang, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void cboDTThangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboDTThangActionPerformed
        // TODO add your handling code here:
        lblNam.setText(cTHDR.loadTongDoanhThuNgay(Integer.valueOf(cboDTThang.getSelectedItem().toString())));
        if (lblNam.getText().isEmpty()) {
            lblNam.setText("0");
        }
