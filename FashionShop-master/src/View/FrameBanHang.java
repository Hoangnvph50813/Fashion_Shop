...
//        addComboNV();
        ...
        setWebcam();
//        if (Integer.valueOf(txtDiem.getText()) < 3) {
...
//        dcbm.addElement("");
    ...
    public void loadTableHoaDon(List<HoaDonViewModel> lst) {
        ...
        for (HoaDonViewModel hd : lst) {
            Object[] row = {
                hd.getMaHD(), hd.getNgayTao(), khachHangService.findNameByIdKH(hd.getKhachHang()), hoaDonService.getTT(hd.getTinhTrang())
            };
    ...
    private void initComponents() {
        ...
        btnReloadDiem = new javax.swing.JButton();
        ...
        jLabel14.setText("Điểm Tích Lũy Của Khách:");

        cboVoucher.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "None", "3", "5", "7" }));

        jLabel15.setText("Voucher:");

        btnApDungVoucher.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnApDungVoucher.setForeground(new java.awt.Color(255, 0, 0));
        ...
        btnReloadDiem.setText("Reload");
        btnReloadDiem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnReloadDiemActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtTienThua, javax.swing.GroupLayout.DEFAULT_SIZE, 278, Short.MAX_VALUE)
                                    .addComponent(txtTienKhachDua)
                                    .addComponent(txtTongTien)
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        .addComponent(txtDiem, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(btnReloadDiem)))
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(lblMaHD, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)
                                    .addComponent(lblNV, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cboVoucher, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel16))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(113, 113, 113)
                        .addComponent(btnApDungVoucher, javax.swing.GroupLayout.PREFERRED_SIZE, 244, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(0, 0, Short.MAX_VALUE))
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel16))
                .addGap(18, 18, 18)
                .addComponent(btnApDungVoucher, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnQR.add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 180, 160));
    ...
    private void tbHoaDonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbHoaDonMouseClicked
        ...
        cbKhachHang.setSelectedItem(tenKH);
...
//        hoaDonService.updateHoaDon(hd, idHD);
        ...
        khachHangRepository.updateLoyaltyPoints(cbKhachHang.getSelectedItem().toString());
    }
...
//        
    ...
    private void btnTaoHoaDonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTaoHoaDonActionPerformed
        ...
        System.out.println(cbKhachHang.getSelectedItem());
        hd.setMaHd(mahd);
        hd.setNgayTao(date);
        hd.setTinhTrang(0);
//        hd.setIdUser("2");
        hd.setIdUser(userService.findIDKHByTen(lblNV.getText()));
        hd.setIdKH(khachHangService.findIDKHByTen(cbKhachHang.getSelectedItem().toString()));
//        khachHangService.findIDKHByTen(cbKhachHang.getSelectedItem().toString());
//        System.out.println(khachHangService.findIDKHByTen(cbKhachHang.getSelectedItem().toString()));
        listhd.add(hd);
...
//        bill_print();
    ...
    private void btnApDungVoucherActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApDungVoucherActionPerformed
        ...
        int phanTramGiam = Integer.valueOf(cboVoucher.getSelectedItem().toString());
    ...
    private void btnReloadDiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReloadDiemActionPerformed
        // TODO add your handling code here:
        if (txtDiem.getText().isEmpty()) {
            txtDiem.setText("0");
        }
        String tenKH = String.valueOf(cbKhachHang.getSelectedItem());
        int temp = khachHangService.findKHByName(tenKH).getDiemTichLuy();
        txtDiem.setText(String.valueOf(khachHangService.findKHByName(tenKH).getDiemTichLuy()));
        if (temp < 3) {
            cboVoucher.setSelectedIndex(0);
        } else if (temp >= 3 && temp < 5) {
            cboVoucher.setSelectedIndex(1);
        } else if (temp >= 5 && temp < 7) {
            cboVoucher.setSelectedIndex(2);
        } else if (temp >= 7) {
            cboVoucher.setSelectedIndex(3);
        }
    }//GEN-LAST:event_btnReloadDiemActionPerformed
    ...
    private javax.swing.JButton btnReloadDiem;
