...
public class HoaDonQL extends javax.swing.JFrame {
    ...
    public void loadBang() {
        ...
        table.setRowCount(0);
        for (HoaDon o : this.hds.selectList()) {
            table.addRow(new Object[]{o.getMaHd(), hds.getNameUSByIDUser(o.getIdUser()), hds.getNameKHByIDKH(o.getIdKH()), o.getNgayTao(), o.getNgayThanhToan(), o.getTinhTrang()});
        }
    }
