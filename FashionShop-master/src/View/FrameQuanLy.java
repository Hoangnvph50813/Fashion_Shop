...
public class FrameQuanLy extends javax.swing.JFrame {
    ...
    public FrameQuanLy() {
        ...
        for (TheLoai temp : tls.getAll()) {
            cbLoaiSP.addItem(temp.getTentl());
        }
    ...
    public void cbChatLieu() {
        ...
        dcbmCL.addElement("");
        for (ChatLieu chatLieu : cls.getAll()) {
            cbChatLieu.addItem(chatLieu.getTen());
        }
    }
    ...
    public void cbMauSac() {
        ...
        dcbmMau.addElement("");
        for (MauSac mauSac : mauSacService.getAll()) {
            cbMauSac.addItem(mauSac.getTen());
        }
    }
    ...
    public void cbKichCo() {
        ...
        dcbmKC.addElement("");
        for (KichCo kichCo : kcs.getAll()) {
            cbKichCo.addItem(kichCo.getSize());
        }
    }
    ...
    public void addCbTheLoai() {
        ...
        for (TheLoai theLoai : tls.getAll()) {
            cbloai.addItem(theLoai.getTentl());
        }
    }
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel8Layout.createSequentialGroup()
                                .addComponent(cbLoaiSP, javax.swing.GroupLayout.PREFERRED_SIZE, 256, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(btnTL, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cbKichCo, javax.swing.GroupLayout.Alignment.TRAILING, 0, 177, Short.MAX_VALUE)
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel10Layout.createSequentialGroup()
                                .addComponent(cbsize, 0, 168, Short.MAX_VALUE)
                                .addGap(35, 35, 35))
                            .addGroup(jPanel10Layout.createSequentialGroup()
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ...
            String Path_name = "E:\\FPT Polytechnic\\";
