...
public class KhachHangService implements IKhachHangService {
    ...
    @Override
    public String findIDKHByTen(String ten) {
        String idKH = "";
        for (var temp : khRepo.getAll()) {
            if (temp.getHoTen().equals(ten)) {
                idKH = temp.getId();
            }
        }
        return idKH;
    ...
    @Override
    public KhachHang findKHByName(String tenKH) {
        for (var temp : khRepo.getAll()) {
            if (temp.getHoTen().equals(tenKH)) {
                return temp;
            }
        }
        return null;
    ...
    @Override
    public String findNameByIdKH(String id) {
        String nameKH = "";
        for (var temp : khRepo.getAll()) {
