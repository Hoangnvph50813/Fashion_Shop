...
public class KhachHangRepository implements IKhachHangRepository {
    ...
    public List<KhachHang> getAll() {
        ...
        try {
            ...
            String sql = "Select Id,Ma,HoTen,NgaySinh,GioiTinh,Sdt,DiaChi,tichDiem from KhachHang";
            ...
            while (rs.next()) {
                ...
                int diem = rs.getInt("tichDiem");

                KhachHang kh = new KhachHang(id, ma, ten, ngaySinh, gioiTinh, sdt, diaChi, diem);
    ...
    public Integer insert(KhachHang kh) {
        try {
            ...
            String sql = "INSERT INTO KhachHang (Ma,HoTen,NgaySinh,GioiTinh,Sdt,DiaChi,tichDiem)"
                    + "VALUES(?,?,?,?,?,?,?)";
    ...
    public ArrayList<KhachHang> timTheoTen(String hoTen) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                KhachHang khachHang = new KhachHang(id, ma, hTen, ngaySinh, gioiTinh, sdt, diaChi, diem);
                list.add(khachHang);
            }
    ...
    @Override
    public Integer updateLoyaltyPoints(String customerName) {
        try {
            Connection conn = DBcontext.getConnection();
            String sql = "UPDATE khachhang SET tichDiem = tichDiem + 1 WHERE HoTen = ?";
            PreparedStatement ps = conn.prepareStatement(sql);
